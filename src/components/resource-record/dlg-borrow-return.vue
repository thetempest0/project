  ...
  export default {
    ...
    methods: {
      ...
      confirm () {
        ...
        api.resourceShare.returnBill(resource.id, model.number, model.borrowDateTime, model.returnDateTime)
          .then(response => {
