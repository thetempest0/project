  ...
  <el-dialog title="打印" v-model="visible" :modal="true" @colse='close()' :modal-append-to-body="false">
    <section class="dialog-body section-border" id='borrowPrint'>
      <el-row type="flex" class="row-margin" justify="space-between">
        ...
        <el-col :span="6" class='center'><label class="center-title">资源归还单</label></el-col>
      ...
      <el-row class="row-margin" type="flex" justify="center" align="center">
        <el-col :span="4">归还日期：</el-col>
        <el-col :span="8" class="col-bottow"></el-col>
        <el-col :span="4">
          <div class="col-margin">接收日期：</div>
        </el-col>
        <el-col :span="8" class="col-bottow"></el-col>
      </el-row>

      <el-row class="row-margin" type="flex" justify="center" align="center">
        <el-col :span="4">归还确认：</el-col>
        <el-col :span="8" class="col-bottow"></el-col>
        <el-col :span="4">
          <div class="col-margin">接收确认：</div>
        </el-col>
        <el-col :span="8" class="col-bottow"></el-col>
      </el-row>
  ...
  export default {
    ...
    methods: {
      show (srcData) {
        ...
        this.model.borrow = srcData.supplierName
        this.model.credit = user.supplierName
